...
export default function page() {
  ...
  return (
    <div className="min-h-[100vh] w-[100vw] bg-secondary dark:bg-black flex flex-col items-center ">
      <div className="sm:w-[67vw] max-sm:w-[90vw]  min-h-80 flex flex-col items-start justify-around mt-4">
        <h1 className="font-inter text-4xl pb-4 font-extralight max-sm:text-2xl">Gyanaranjan Patra</h1>
